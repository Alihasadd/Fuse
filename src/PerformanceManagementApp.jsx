...
const PerformanceManagementApp = () => {
  ...
  const questions = [
    ...
    "What's one thing you feel you need to improve in to reach your career goals?",
    "What's one thing your manager can do to make work better for you?",
    "What's one thing you'd like to change about how you work together?",
    "Is the manager doing a good enough job bringing you into team decisions? Would you like to be more involved?",
    "How do you feel about the current team dynamics? Is there anything we can improve?",
    "What do you think is the biggest challenge facing our team right now?",
    "How do you feel about the current workload? Is it manageable or overwhelming?",
    "What do you think is the most important goal for our team this quarter?",
    "How do you feel about the current communication within the team? Is it effective or could it be improved?",
    "What do you think is the biggest opportunity for our team to grow and improve?",
    "How do you feel about the current level of recognition and appreciation within the team?",
    "What do you think is the most important skill for our team to develop right now?",
    "How do you feel about the current level of collaboration within the team? Is it effective or could it be improved?",
    "What do you think is the biggest barrier to our team's success right now?",
    "How do you feel about the current level of trust within the team? Is it strong or could it be improved?",
    "What do you think is the most important thing we can do to support each other as a team?",
    "How do you feel about the current level of innovation within the team? Is it encouraged or could it be improved?",
    "What do you think is the most important thing we can do to improve our team's performance?",
    "How do you feel about the current level of feedback and coaching within the team? Is it effective or could it be improved?",
    "What do you think is the most important thing we can do to create a positive team culture?",
    "How do you feel about the current level of alignment within the team? Are we all on the same page or could it be improved?",
    "What do you think is the most important thing we can do to improve our team's collaboration?",
    "How do you feel about the current level of accountability within the team? Is it strong or could it be improved?",
    "What do you think is the most important thing we can do to improve our team's decision-making process?",
    "How do you feel about the current level of support and resources available to the team?",
    "What do you think is the most important thing we can do to improve our team's problem-solving skills?",
    "What do you think makes our company culture unique, and are there any aspects you think could be improved?", 
    "What challenges do you face in your role that aren't visible to others?",
    "What, if anything, is stressing you out right now?",
    "What is your ideal way to receive feedback, and how can I better support that?",
    "Are there any skills that you feel you need to develop further to excel in your role?",
    "Are there areas of interest or passions that we can help you explore within your current role?",
